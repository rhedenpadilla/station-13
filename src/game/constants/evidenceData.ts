...
export const EVIDENCE_DATABASE: Record<string, EvidenceItem> = {
  ...
  beacon_system: {
    ...
    icon: 'zap',
    connectedTo: ['signal_13_first', 'beacon_calibration_data', 'signal_tower_array'],
  },
  time_loop_evidence: {
    ...
    icon: 'alert',
    connectedTo: ['sleeping_quarters_photo', 'beacon_calibration_data', 'signal_13_first', 'operator_final_dossier'],
  },
  operator_final_dossier: {
    id: 'operator_final_dossier',
    category: 'BLACK_TIDE',
    title: 'Signal Tower Log 1986',
    subtitle: 'Final Transmission Dossier',
    summary: 'The 1986 operator discovered that the 13.13 MHz resonance does not merely illuminate the shoals—it connects two realities. Transmitting on 13.13 MHz locks the temporal bridge permanently.',
    timestamp: 'Tower Archives',
    icon: 'file',
    connectedTo: ['time_loop_evidence', 'signal_tower_array', 'tape_a_recording'],
  },
  signal_tower_array: {
    id: 'signal_tower_array',
    category: 'BEACON',
    title: 'Signal Tower Optical Array',
    subtitle: 'Sector 13 Upper Beacon Deck',
    summary: 'High-elevation transmitter housing the master quartz crystal oscillator. Calibrated to bridge the atmospheric electromagnetic anomaly.',
    timestamp: 'Upper Deck',
    icon: 'zap',
    connectedTo: ['beacon_system', 'operator_final_dossier'],
  },
};
